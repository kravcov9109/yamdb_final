# Generated by Django 3.0.5 on 2021-02-01 19:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(10, 'Оценка не может превышать 10')], verbose_name='Оценка')),
            ],
            options={
                'ordering': ('-pub_date',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(default=2021, validators=[django.core.validators.MaxValueValidator(2021)])),
                ('rating', models.PositiveSmallIntegerField(null=True, validators=[django.core.validators.MaxValueValidator(10, 'Рейтинг не может быть выше 10')], verbose_name='Рейтинг')),
